...
class Timer extends React.Component {
  ...
  getTimerLog(eventLog){
    ...
    if(eventLog){
      ...
      return 'Not-Applicable, Hello World this is a sample text. this is a sample text.Not-Applicable, Hello World this is a sample text.';
    }
    ...
    return (
      <div className='ui centered card'>
        <div className='content'>
          ...
          <div>
          Logs { this.getTimerLog(this.props.timerLog) }
          </div>
